...
func GetDefaultTemplates() []NotificationTemplate {
	return []NotificationTemplate{
		...
		},
		{
			...
			Prompt:    "Создай мотивирующее сообщение парам о выполнении психологических упражнений для укрепления отношений. Сообщение должно быть на русском языке, позитивным и вдохновляющим. Используй эмодзи. Длина 50-100 слов.",
			IsActive:  true,
			CreatedAt: time.Now(),
			UpdatedAt: time.Now(),
		},
